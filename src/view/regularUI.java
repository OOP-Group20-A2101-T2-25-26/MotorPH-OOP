...
public class regularUI extends mainMenuFunctions {
    ...
    private JPanel createHeaderPanel() {
        ...
        headerPanel.setBackground(UIConstants.PRIMARY_COLOR_R);
        ...
        try {
            ...
            java.net.URL logoUrl = regularUI.class.getResource("/view/assets/logo.png");
            if (logoUrl == null) {
                System.err.println("ERROR: Logo resource not found in classpath: /view/assets/logo.png");
                // Try alternate path
                logoUrl = regularUI.class.getResource("assets/logo.png");
                if (logoUrl == null) {
